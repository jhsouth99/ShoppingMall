			...
			<div class="container">
				<nav class="main-nav">
					<ul>
						...
						<li class="has-submenu"><a href="<c:url value='/electronics'/>">전자기기</a>
							<ul class="submenu">
						...
						<li class="has-submenu"><a href="<c:url value='/group-purchase'/>">공동구매</a>
							<ul class="submenu">
				...
				<div class="slider-container">
					...
					<div class="slider-controls-and-dots">
						<button class="slider-control prev">
							<img src="<c:url value='/resources/images/left-arrow.png'/>" alt="이전 배너">
						</button>
						...
						<button class="slider-control next">
							<img src="<c:url value='/resources/images/right-arrow.png'/>" alt="다음 배너">
						</button>
					</div>
				</div>
			</div>
						...
						<c:forEach var="dto" items="${list}">
						    <div class="product-card" data-product-id="${dto.id}">
						        <div class="product-image">
						            ...
						            <c:if test="${not empty dto.discount_rate and dto.discount_rate > 0}">
						        ...
						        <div class="product-info">
						            ...
						            <div class="product-price">
						                <c:choose>
						                    <c:when test="${not empty dto.discount_rate and dto.discount_rate > 0}">
						                        <div class="original-price">
						                            <fmt:formatNumber value="${dto.base_price}" pattern="#,###"/>원
						                        </div>
						                        <div class="discount-price">
						                            <c:choose>
						                                <c:when test="${not empty dto.discount_price}">
						                                    <fmt:formatNumber value="${dto.discount_price}" pattern="#,###"/>원
						                                </c:when>
						                                <c:otherwise>
						                                    <c:set var="discountPrice" value="${dto.base_price * (1 - dto.discount_rate / 100)}" />
